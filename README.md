...
Below, we see the two phylogenetic trees generated by the workflow. Very similar but potentially different slightly different phylogenetic trees will be generated each time the pipeline is run. This is due to the randomized bootstrapping nature of RAxML.  
